...
library(itssl)
library(gradethis)
gradethis_setup(  exercise.timelimit = 60,
  exercise.checker = grade_learnr,
  exercise.error.check.code = "grade_code()")
#tutorial_options(exercise.error.check.code = NULL)
...
<!-- Dataframes are rectangular spreadsheet style objects that hold data we wish to analyse. There is a small one called `df` loaded into memory for you, the function `str()` tells us about a dataframe. Use `str()` on the dataframe `df` -->

<!-- ```{r, echo=FALSE} -->
<!-- df <- its_small_data_frame_time() -->
<!-- ``` -->
...
<!--   answer("it is text-based data", correct = TRUE), -->
...
<!--   answer("Yes!"), -->
<!--   answer("No"), -->
<!--   answer("No, but that's ok, Ive read the help and it's a bit opaque, but I think some googling will help", correct = TRUE) -->
<!--   ) -->
